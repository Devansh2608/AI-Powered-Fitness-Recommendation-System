...
//This service is used to process the responses of AI
...
public class ActivityAIService {
    ...
    private Recommendation createDefaultRecommendation(Activity activity) {
        return Recommendation.builder()
                ...
                .suggestions(Collections.singletonList("Consider consulting a firness coach"))
    ...
    private String createPromptForActivity(Activity activity) {
        ...
        return String.format("""
                        Analuse this fitness activity and provide detailed recommendations in the exact json format:
                        {
                            "analysis":{
